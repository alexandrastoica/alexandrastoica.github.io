...
title: 'PotatoCon'
slug: 'potatocon'
preview: 'A mobile app for scheduling events and sending out notifications'
label: 'Mobile app'
date: 'September 2017'
context:
...
![PotatoCon logo](./images/image1.jpg 'PotatoCon logo - not my design')
...
![Initial PotatoCon wireframes, made in Sketch](./images/image2.png 'Initial PotatoCon wireframes, made in Sketch')
...
![PotatoCon workflow](./images/image3.png 'PotatoCon workflow')
...
![Final app screenshots, iOS](./images/image4.png 'Final app screenshots, iOS')
