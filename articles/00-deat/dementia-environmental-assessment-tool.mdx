...
preview: Paper-based tool turned mobile app
label: Mobile app
date: May 2017
links:
  - https://play.google.com/store/apps/details?id=com.ionicframework.deatapp&hl=en
  - https://github.com/alexandrastoica/ionic2-assessment-app
context:
  - Media Lab, University of Worcester, UK
  - Collaboration with [NHS King's Fund](http://) and Association for Dementia Studies
languages:
  - Angular
  - HTML5 + Sass
...
See [the app on Google Play Store](https://play.google.com/store/apps/details?id=com.ionicframework.deatapp&hl=en). The app was not published by me.
